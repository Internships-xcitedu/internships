...
const SignUp = () => {
  return (
    <>
    <div className=' box-border bg-gray-100 w-[386px] sm:w-[714px] h-[600px] absolute top-[2%] tablet:top-[2%] laptopMd:top-[60px] left-[0px] tablet:left-[30px] laptopMd:left-[404px]  rounded-2xl container1 '>
